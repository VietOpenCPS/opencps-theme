...
<body class="mBody">
	...
	<div id="app"></div>
	<script type="text/javascript" src="${themeDisplay.getPathThemeRoot()}js/manifest.374c27ece7c0c7548407.js"></script>
	<script type="text/javascript" src="${themeDisplay.getPathThemeRoot()}js/vendor.856f027bc808ea1fc2b1.js"></script>
	<script type="text/javascript" src="${themeDisplay.getPathThemeRoot()}js/app.ab667329115e68e234b0.js"></script>
