...
<head>
	<title>Kho kết quả thủ tục hành chính Bộ GTVT</title>
	...
	<!-- Config Scope -->
	<script type="text/javascript">
		var setUrlRedirect = window.location.origin + "/web/kho-dien-tu/login";
...
<div class="container-fluid" id="wrapper" style="overflow: hidden;">
	<header id="banner" class="row header-kho">
		<div class="mLogo align-middle"> 
			<a href="javascript:;"> 
				<img src="${themeDisplay.getPathThemeRoot()}/images/logo-header-page.png"> 
				<div class="text-logo"> 
					<span style="font-family: Lora;
					font-style: normal;
					font-weight: bold;
					font-size: 16px;
					line-height: 20px;
					text-transform: uppercase;
					color: #273B98;margin-bottom: 3px;">Kho Kết quả thủ tục hành chính</span>
					<span style="font-family: Lora;
					font-style: normal;
					font-weight: normal;
					font-size: 16px;
					...
					color: #273B98;">Bộ Giao thông vận tải</span>
				</div> 
			</a> 
		</div>
		
		<div id="react-root" style="float: right;width: 100%;height: 57px;">
	...
	<footer id="footer" class="footer-page">
		<div class="sitename" style="margin-bottom: 6px;font-family: Nunito;
		font-style: normal;
		font-weight: normal;
		font-size: 14px;
		line-height: 19px;
		...
		<div class="layout wrap">
			<div class="" style="">
				<img class="icon-label" src="${themeDisplay.getPathThemeRoot()}/images/info-icon2.png">
				<span class="text-footer">80 Trần Hưng Đạo, Hoàn kiếm, Hà Nội</span>
			</div>
			<div class="" style="">
				<img class="icon-label" src="${themeDisplay.getPathThemeRoot()}/images/info-icon3.png">
				<span class="text-footer">Hotline: 1900 0318 - Điện thoại: (024) 3.822.2979</span>
			</div>
			<div class="" style="">
				<img class="icon-label" src="${themeDisplay.getPathThemeRoot()}/images/info-icon4.png">
				<span class="text-footer">Fax: (024) 3.822.1066</span>
			</div>
			<div class="">
				<img class="icon-label" src="${themeDisplay.getPathThemeRoot()}/images/info-icon5.png">
				<span class="text-footer">Email: bophanhotro@mt.gov.vn</span>
			</div>
		</div>
	</footer>
<!-- inject:js -->
	<script type="text/javascript" src="/o/opencps-store/js/cli/login/app/js/app.js?t=93124123123"></script>
	<script type="text/javascript" src="/o/opencps-store/js/cli/login/app/js/chunk-vendors.js?t=93124123123"></script>
	<#if permissionChecker.isOmniadmin()>
...
<script type="text/javascript">
	...
	<style>
		...
		.page-theme #banner {
			background: url("/o/khodientu-theme/images/bg-header-page-1366.png");
...
.hidden__temp {
	...
	body footer {
		height: 80px;
		color: #fff;
		background: url("/o/khodientu-theme/images/bg-footer-page-1366.png");
		background-size: cover;
		width: 100%;
		bottom: 0;
		left: 0;
	...
	@media screen and (min-width: 1920px) {
		.page-theme #banner {
			background: url("/o/khodientu-theme/images/bg-header-page-1920.png")
		}
		body footer {
			background: url("/o/khodientu-theme/images/bg-footer-page-1920.png");
		}
	}
	/*  */
	</style>
