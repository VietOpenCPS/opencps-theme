...
<head>
	...
	<base href="/">
	<link href="${themeDisplay.getPathThemeRoot()}/css/base-style.css?t=883412388" rel="stylesheet" type="text/css">
	<link href="${themeDisplay.getPathThemeRoot()}/css/main.css?t=883128318" rel="stylesheet" type="text/css">
...
<body class="${css_class} mBody page-theme">
	...
	<a href="/web/dich-vu-cong-mic" class="bth"><i class="fa fa-home" aria-hidden="true"></i></a>
